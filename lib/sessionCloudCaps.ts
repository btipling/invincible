 ...
 * fitting tail's span to this ceiling (newest suffix adjacent to the tail,
 * not the oldest prefix — adversarial #955 follow-up 8) instead of returning
 ...
 * PR #955 / plan #950). Suffix-clip `span` + `retainedTail` is the newest
 * contiguous suffix (not two views of the full seed). Independently railed
 ...
 * trim. Checkpoint-clip `failOpenSeed` (Goal 4 pin) counts when present;
 * mm-seed clip omits it (adversarial #955 follow-up 8). **NEW generous cap**;
