 ...
 * #870). The post-turn persist still throws and paints once.
 */
 ...
 * Quota throw → `pushHostQuotaError` unless `{ paint: false }`. Other throws
 * are not expected (`save` swallows non-quota) and are not rethrown.
 */
