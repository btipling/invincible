...
/**
 * Client-safe mirror of a server skill attach/detach outcome (phase 3 #497).
 * Carries ONLY the slug + outcome — never a skill body. Pushes the display-only
 * `Skill attached: <slug>` / `Skill detached: <slug>` rows in the JSON agent
