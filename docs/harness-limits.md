...
| Session longer than ring | Host `SessionStore` / cloud row may hold more; ring shows a **window** of ≤2048. **Load earlier** steps back by **`HISTORY_PAGE` = 512**; new send snaps to latest window |
