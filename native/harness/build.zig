...
pub fn build(b: *std.Build) void {
    ...
    // PR #681: queue_band cancel glyph constant (U+2715 DejaVu subset, not
    // U+00D7 which is not in the shipped DejaVu ranges). Pure unit test,
    // but queue_band imports dvui transitively.
    {
