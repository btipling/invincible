...
pub fn build(b: *std.Build) void {
    ...
    const test_rich = b.step("test-rich", "Run rich/* host unit tests (parse, cache, links, kinds, diff_lang, highlight, unicode_face, blockquote, table, thematic, footnote, deflist)");
