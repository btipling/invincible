...
|------|--------|------|---------|
| `NotoSans-Regular.ttf` / `NotoSans-Bold.ttf` | Noto Sans | body / heading | SIL OFL 1.1 (Google Noto) |
...
- Noto Sans: Latin, Greek, Cyrillic, and broad European punctuation — **not** full CJK.
